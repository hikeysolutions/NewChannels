...
function buildPrompt({ title, entity, situation, channel, scriptText }) {
  ...
  return [
    ...
    "    render.subject_type: who or what is in frame. MUST be one of exactly: period_people, modern_people, animal, object, landscape, structure, abstract. Use period_people for people of the scene's own historical era; use modern_people ONLY for present-day contrast people (pair it with era \"modern\").",
