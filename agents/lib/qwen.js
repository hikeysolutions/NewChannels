...
function buildPrompt({ title, entity, situation, channel, scriptText }) {
  ...
  return [
    ...
    "",
    "Rules:",
    "- Split the script into ordered scenes, one scene per beat or natural narration chunk. A sentence stating a single quantity (a duration, distance, proportion, count, or trend) gets ITS OWN short scene with render.subject_type \"data_visual\" (see the data_visual rules below).",
    ...
    "",
    "JSON shape:",
    '{ "scenes": [ { "index": 1, "beat": "hook", "start": 0, "end": 4, "asset_type": "still", "gap_type": "new_fact", "gap_state": "opens", "render": { "era": "prehistoric", "location": "inside a firelit cave", "subject_type": "period_people", "style": "channel_default" }, "visual_prompt": "...", "on_screen_text": "...", "narration": "..." }, { "index": 2, "beat": "context", "start": 4, "end": 7, "asset_type": "still", "gap_type": "escalation", "gap_state": "opens", "render": { "era": "prehistoric", "location": "", "subject_type": "data_visual", "style": "channel_default" }, "visual_prompt": "a horizontal timeline bar showing fourteen hours of darkness, dark baseline with one accent segment", "on_screen_text": "14 hours", "narration": "Fourteen hours of darkness, every single night." } ] }',
    "",
    `channel: ${channel}`,
    `title: ${title}`,
    `entity: ${entity}`,
